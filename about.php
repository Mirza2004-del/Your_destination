        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">Odisha offers rich cultural heritage, stunning beaches, and vibrant festivals. Its diverse landscapes include serene coastlines and lush forests, perfect for nature lovers and explorers. </p>
                    <p class="mb-4">The state is also known for its unique art, temples, and traditions.</p>
